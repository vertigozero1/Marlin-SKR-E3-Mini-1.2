...
#define STRING_CONFIG_H_AUTHOR "(qwewer1/vertigozero1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TA-SKRmE3v2"
...
#define DEFAULT_EJERK    15.0  // May be used by Linear Advance (default 5)
